...
def load_modules():
    from modules import (StockDataFetcher, RiskAnalysisEngine, SupplyChainModel,
                         HiddenRiskDetector, MultimediaContent, RiskVisualizer)
    return (StockDataFetcher(), RiskAnalysisEngine(), SupplyChainModel(),
            HiddenRiskDetector(), MultimediaContent("600519", "贵州茅台"), RiskVisualizer())
